...
/* includes */
#include "core_cm4.h"  //此处包含在KEIL的库里面，所以不用添加进来,类似stdint.h头文件，用到核内外设再添加
...
#if !defined  USE_STDPERIPH_DRIVER  //如果没有定义，将无法使用外设
#define USE_STDPERIPH_DRIVER
#endif 
#ifdef USE_STDPERIPH_DRIVER
#include "gd32f30x_libopt.h"  //启用外设头文件,可以自己编写
