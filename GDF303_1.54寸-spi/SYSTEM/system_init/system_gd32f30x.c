...
#define __SYSTEM_CLOCK_120M_PLL_HXTAL           (uint32_t)(120000000)  //启动120M主频
...
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_IRC8M;
static void system_clock_8m_irc8m(void);
#elif defined (__SYSTEM_CLOCK_48M_PLL_IRC8M)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_48M_PLL_IRC8M;
static void system_clock_48m_irc8m(void);
#elif defined (__SYSTEM_CLOCK_72M_PLL_IRC8M)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_72M_PLL_IRC8M;
static void system_clock_72m_irc8m(void);
#elif defined (__SYSTEM_CLOCK_108M_PLL_IRC8M)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_108M_PLL_IRC8M;
static void system_clock_108m_irc8m(void);
#elif defined (__SYSTEM_CLOCK_120M_PLL_IRC8M)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_120M_PLL_IRC8M;
static void system_clock_120m_irc8m(void);
#elif defined (__SYSTEM_CLOCK_168M_PLL_IRC8M)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_168M_PLL_IRC8M;
static void system_clock_168m_irc8m(void);

#elif defined (__SYSTEM_CLOCK_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_HXTAL;
static void system_clock_hxtal(void);
#elif defined (__SYSTEM_CLOCK_48M_PLL_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_48M_PLL_HXTAL;
static void system_clock_48m_hxtal(void);
#elif defined (__SYSTEM_CLOCK_72M_PLL_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_72M_PLL_HXTAL;
static void system_clock_72m_hxtal(void);
#elif defined (__SYSTEM_CLOCK_108M_PLL_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_108M_PLL_HXTAL;
static void system_clock_108m_hxtal(void);
#elif defined (__SYSTEM_CLOCK_120M_PLL_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_120M_PLL_HXTAL;
static void system_clock_120m_hxtal(void);
#elif defined (__SYSTEM_CLOCK_168M_PLL_HXTAL)
uint32_t gd32f30x_SystemCoreClock = __SYSTEM_CLOCK_168M_PLL_HXTAL;
...
void gd32f30x_SystemInit (void)
{
  /* FPU settings */
    ...
    /* Set IRC8MEN bit */
    RCU_CTL |= RCU_CTL_IRC8MEN;   //内部8MHz RC振荡器使能
	...
	****************************************/
	...
	//1.HXTALEN:高速3~25MHz晶体振荡器关闭  
	//2.CKMEN:  禁止高速3 ~ 25 MHz晶体振荡器(HXTAL)时钟监视器
	//3.PLLEN:  PLL时钟关闭
...
static void system_clock_48m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLMF | RCU_CFG0_PLLMF_4 | RCU_CFG0_PLLMF_5);
    RCU_CFG0 |= (RCU_PLLSEL_HXTAL_IRC48M | RCU_PLL_MUL12);

    /* CK_PREDIV0 = (CK_HXTAL)/5 *8 /10 = 4 MHz */ 
    RCU_CFG1 &= ~(RCU_CFG1_PLLPRESEL | RCU_CFG1_PREDV0SEL | RCU_CFG1_PLL1MF | RCU_CFG1_PREDV1 | RCU_CFG1_PREDV0);
    RCU_CFG1 |= (RCU_PLLPRESEL_HXTAL | RCU_PREDV0SEL_CKPLL1 | RCU_PLL1_MUL8 | RCU_PREDV1_DIV_5 | RCU_PREDV0_DIV_10);
...
static void system_clock_72m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLMF | RCU_CFG0_PLLMF_4 | RCU_CFG0_PLLMF_5);
    RCU_CFG0 |= (RCU_PLLSEL_HXTAL_IRC48M | RCU_PLL_MUL18);
...
static void system_clock_108m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLMF | RCU_CFG0_PLLMF_4 | RCU_CFG0_PLLMF_5);
    RCU_CFG0 |= (RCU_PLLSEL_HXTAL_IRC48M | RCU_PLL_MUL27);
...
static void system_clock_120m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLMF | RCU_CFG0_PLLMF_4 | RCU_CFG0_PLLMF_5);
    RCU_CFG0 |= (RCU_PLLSEL_HXTAL_IRC48M | RCU_PLL_MUL30);
...
static void system_clock_168m_hxtal(void)
{
    ...
    RCU_CFG0 &= ~(RCU_CFG0_PLLMF | RCU_CFG0_PLLMF_4 | RCU_CFG0_PLLMF_5);
    RCU_CFG0 |= (RCU_PLLSEL_HXTAL_IRC48M | RCU_PLL_MUL42);
...
#endif /* __SYSTEM_CLOCK_IRC8M */
/*!
    \brief      update the gd32f30x_SystemCoreClock with current core clock retrieved from cpu registers
    \param[in]  none
    \param[out] none
    \retval     none
*/
void gd32f30x_gd32f30x_SystemCoreClockUpdate (void)
{
    uint32_t sws;
    ...
    case SEL_IRC8M:
        gd32f30x_SystemCoreClock = IRC8M_VALUE;
        break;
    /* HXTAL is selected as CK_SYS */
    case SEL_HXTAL:
        gd32f30x_SystemCoreClock = HXTAL_VALUE;
        break;
    ...
    case SEL_PLL:
        ...
        gd32f30x_SystemCoreClock = ck_src*pllmf;
    #ifdef GD32F30X_CL
        if(13U == pllmf){
            gd32f30x_SystemCoreClock = ck_src*6U + ck_src/2U;
        }
    #endif /* GD32F30X_CL */
